...
public class Rectangulo extends Cuadrilatero{
    ...
    public Rectangulo(double x1, double x2, double x3, double x4, double y1, double y2, double y3, double y4, double area, double lado1, double lado2, double lado3, double lado4) {
    ...
    public void CalcularArea() {
        ...
        if(lado1 != lado3 || lado2!= lado4){
            System.out.println("---- Lo siento No es un Rectangulo ----");
            System.out.println("");
        }else{
        ...
        System.out.println("El Area del Rectangulo es: "+area+" u2");
        }
        }
