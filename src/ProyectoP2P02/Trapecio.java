...
public class Trapecio extends Cuadrilatero{
    ...
    public Trapecio(double x1, double x2, double x3, double x4, double y1, double y2, double y3, double y4, double area, double lado1, double lado2, double lado3, double lado4) {
    ...
    public void CalcularArea() {
        System.out.println("---------- Calcular el Area del Trapecio ----------");
        System.out.println(" ");
        ...
        if(lado1 == lado3 || lado2 ==lado4){
            System.out.println("---- Lamentablemente No es Un Trapecio ----");
            System.out.println("");
        }else{
        ...
        h = Math.abs((lado1-lado3));
        area = (((lado1+lado3)/2)*h);
        
        System.out.println("El Area del Trapecio es: "+area+" u2");
    }
    }
